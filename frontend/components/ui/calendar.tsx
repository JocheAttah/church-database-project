  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: "w-8 font-normal text-[0.8rem] text-neutral-400",
        ...
        today: "bg-neutral-800 text-neutral-50",
        outside:
          "day-outside opacity-50 aria-selected:opacity-90 text-neutral-400 aria-selected:bg-bg-white aria-selected:text-neutral-900",
        disabled: "opacity-50 text-neutral-400",
        range_middle:
